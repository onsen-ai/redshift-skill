-- Table DDL generation (extracted from amazon-redshift-utils v_generate_tbl_ddl)
-- Placeholders: {schema_filter} — optional WHERE clause for schemaname/tablename filtering
SELECT
 table_id
