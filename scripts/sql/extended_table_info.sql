-- Extended table info (extracted from amazon-redshift-utils v_extended_table_info)
...
SELECT ti.database,
      ...
      CASE
       ...
       ti.size || '/' || CASE
         ...
         ti.unsorted,
         ti.stats_off,
         Nvl(tbl_scans.num_scans,0) || ':' || Nvl(rr_scans.rr_scans,0) || ':' || Nvl(rr_scans.filtered_scans,0) || ':' || Nvl(scan_alerts.selective_scans,0) || ':' || Nvl(scan_alerts.delrows_scans,0) AS "scans:rr:filt:sel:del",
         tbl_scans.last_scan
